...
public class CreateCarRequest {
    ...
    public CreateCarRequest(String brand, String model, Integer year, String plateNumber, String color, String photoUrl) {
        this.brand = brand;
        this.model = model;
        this.year = year;
    ...
    public CreateCarRequest(String brand, String model, Integer year, String plateNumber, String color) {
